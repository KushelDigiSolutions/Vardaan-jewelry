...
export default function AboutVisionMission() {
  return (
    <section className="py-32 px-6 md:px-16 lg:px-24 bg-[#FAF9F6] overflow-hidden">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-4 flex flex-col items-start gap-4">
          ...
          <h2 className="text-3xl md:text-4.5xl font-serif text-[#07512E] font-light leading-tight uppercase tracking-wide">
            Our Purpose & <br />
            <span className="font-normal text-amber-600">Direction</span>
          </h2>
          <div className="w-12 h-[2px] bg-[#FFDE59] mt-1" />
          <p className="text-xs text-gray-500 font-light leading-relaxed max-w-xs mt-2">
        ...
        <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-6 relative mt-12 lg:mt-0">
          ...
          <div className="bg-[#07512E] text-white p-8 md:p-10 rounded-lg shadow-xl hover:-translate-y-4 transition-all duration-500 relative border border-white/5 lg:translate-y-6 flex flex-col gap-4 group">
            <span className="text-[9px] tracking-[0.3em] text-[#FFDE59] uppercase font-semibold">
              01 • Future
            </span>
            <h3 className="text-xl md:text-2xl font-serif uppercase tracking-wide text-[#FFDE59]">
              Our Vision
            </h3>
          ...
          <div className="bg-white text-gray-900 p-8 md:p-10 rounded-lg shadow-xl hover:-translate-y-4 transition-all duration-500 relative border border-gray-100 lg:-translate-y-6 flex flex-col gap-4 group">
            <span className="text-[9px] tracking-[0.3em] text-amber-600 uppercase font-semibold">
              02 • Execution
            </span>
            <h3 className="text-xl md:text-2xl font-serif uppercase tracking-wide text-[#07512E] group-hover:text-amber-600 transition-colors">
              Our Mission
            </h3>
