        ...
        {slides.map((slide, idx) => (
          ...
          >
            ...
            <div className="absolute inset-0 max-w-[1440px] mx-auto z-20 pointer-events-none">
              <div
                className="pointer-events-auto flex flex-col items-start text-left justify-center select-none
                absolute 
              ...
              >
                ...
                {idx === 2 ? (
                  ...
                  <a
                    href="https://wa.me/919217042525?text=Hi%20Vardaan,%20I%20want%20to%20know%20more%20about%20your%20jewellery."
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ animationDelay: "1700ms" }}
                    className={`mt-4 inline-flex items-center gap-2 bg-[#25D366] text-white font-semibold px-6 py-3 rounded-full hover:bg-[#1EBE5D] transition-all duration-300 ${
