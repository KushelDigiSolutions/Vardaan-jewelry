      ...
      <div className="w-full max-w-[1192px] mx-auto px-4 md:px-8 lg:px-12 xl:px-0 flex flex-col items-center gap-1 relative z-10 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 xl:min-w-300 w-full mt-8 max-w-4xl text-left border border-white/10 p-10 rounded-lg bg-[#053D22]/50 backdrop-blur-md">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-[18px] text-gray-300 font-light leading-relaxed">Established in 2005, Vardaan began as a premier jewelry house crafting sacred, timeless heirloom pieces with uncompromising dedication.</p>
          </div>
          <div className="flex flex-col gap-2 border-t md:border-t-0 md:border-x border-white/10 pt-6 md:pt-0 md:px-8">
            ...
            <p className="text-[18px] text-gray-300 font-light leading-relaxed">Every piece of Vardaan jewelry adheres to strict BIS hallmarking standards and IGI diamond certifications, ensuring absolute purity and trust.</p>
          </div>
          <div className="flex flex-col gap-2 border-t md:border-t-0 pt-6 md:pt-0">
            ...
            <p className="text-[18px] text-gray-300 font-light leading-relaxed">We stand by our craftsmanship with complimentary professional jewelry cleaning, rigorous inspection, and polishing for the lifetime of your product.</p>
          </div>
        </div>
