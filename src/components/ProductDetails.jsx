...
export default function ProductDetails() {
  ...
  return (
    <div className="w-full max-w-[1192px] min-h-[808px] mx-auto px-4 lg:px-0 py-10 lg:py-16">
      <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-6">
        ...
        <div className="w-full lg:w-[365px] flex flex-col order-2 lg:order-1 shrink-0">
          <h1 className="text-[28px] sm:text-[34px] lg:text-[40px] font-sans font-medium text-[#303030] leading-tight mb-2">
            Sparkling Elegance Elara CZ Statement Ring
          </h1>
          
          <p className="text-[11px] font-sans text-gray-400 font-bold tracking-[0.15em] uppercase mb-6">
            Online Exclusive
          </p>

          <div className="mb-6">
            <p className="text-[22px] text-[#303030] font-medium font-sans flex items-baseline gap-1.5">
              INR: <span className="font-bold text-[24px]">4000</span>
            </p>
            <p className="text-[13px] text-gray-400 font-sans tracking-wide mt-1">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-center mb-3">
              ...
              <a href="#size-guide" className="text-[#07512E] text-[13px] font-medium underline underline-offset-4 decoration-1">
                Size guide
              </a>
            </div>
              ...
              {["50", "52", "55", "58", "60"].map((size) => (
                <button
                  ...
                  className={`w-11 h-11 border flex items-center justify-center text-[15px] font-sans transition-colors cursor-pointer ${
                    selectedSize === size 
                      ? "bg-[#07512E] border-[#07512E] text-white font-medium" 
          ...
          {/* Quantity */}
          <div className="mb-8">
            <p className="text-[15px] font-sans text-gray-700 mb-3">Quantity</p>
            <div className="flex border border-gray-300 w-fit">
              ...
              <div className="w-10 h-10 flex items-center justify-center text-[15px] font-sans border-x border-gray-300">
                {quantity}
              </div>
              <button 
          ...
          <div className="flex flex-col gap-3 mb-4">
            <button className="w-full bg-[#FFDE59] text-[#101010] hover:bg-[#e6c543] font-sans font-medium text-[20px] py-3 transition-colors cursor-pointer">
              Shop Now
            </button>
            <button 
              onClick={() => {
              ...
              className="w-full border border-[#07512E] text-[#07512E] bg-white hover:bg-[#07512E] hover:text-white font-sans font-medium text-[20px] py-3 transition-colors cursor-pointer"
            >
              Add to Cart
            </button>
          </div>
          ...
          <div className="text-center mb-8">
            <a href="#shipping" className="text-gray-600 text-[13px] font-sans underline underline-offset-4 decoration-1">
              Shipping calculated at checkout
            </a>
          </div>

          {/* Delivery Estimate Box */}
          <div className="border border-[#FBEF9A] rounded px-4 py-4 mb-8 bg-[#fffff8]">
            <div className="flex justify-between items-center mb-3 text-[13px] text-gray-700 font-sans">
              <span>Delhi / NCR :</span>
            ...
            <p className="text-red-500 text-[13px] font-medium font-sans mt-2">
          ...
          <div className="flex items-center gap-6 text-[#606060]">
            <button className="flex items-center gap-2 text-[14px] font-sans hover:text-[#07512E] transition-colors cursor-pointer font-medium">
        ...
        <div className="w-full lg:w-[395px] flex flex-col gap-4 order-1 lg:order-2 shrink-0">
          ...
          <div className="w-full aspect-square bg-[#F7F5F0] overflow-hidden relative">
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center justify-center gap-2 px-4 py-2">
              {[1, 2, 3].map((num) => (
                <div key={num} className={`w-16 h-12 bg-gray-200 border-2 cursor-pointer ${num === 1 ? 'border-[#07512E]' : 'border-transparent'}`}>
        ...
        <div className="w-full lg:w-[384px] flex flex-col order-3 shrink-0">
          ...
          <div className="bg-[#FFFDF4] p-6 sm:p-8 border border-[#F5EEDC] mb-8">
            <h2 className="text-[26px] font-serif text-[#303030] mb-4">
              Product Discription
            </h2>
            <div className="w-full h-px bg-[#E5DCC5] mb-6"></div>
            
            <p className="text-[14px] text-[#404040] font-sans leading-relaxed mb-6">
            ...
            <ul className="text-[14px] text-[#404040] font-sans space-y-2 list-disc pl-4">
          ...
          <div className="mb-8 pl-1">
            ...
            <div className="flex items-center gap-2">
              <FaCcVisa className="text-[#1434CB] w-10 h-auto" />
              <FaCcMastercard className="text-[#EB001B] w-10 h-auto" />
              <FaCcAmex className="text-[#002663] w-10 h-auto" />
              <FaCcPaypal className="text-[#003087] w-10 h-auto" />
            </div>
          </div>
          ...
          <div className="border border-gray-200 p-5 flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-[15px] text-[#303030] font-sans font-semibold">Find in store</span>
              <a href="#click-collect" className="text-[12px] text-gray-500 font-sans underline underline-offset-2">
